...
pub async fn get_warning_count(pool: &PgPool, group_id: i64, user_id: i64) -> Result<i64, sqlx::Error> {
...
pub async fn reset_warnings(pool: &PgPool, group_id: i64, user_id: i64) -> Result<u64, sqlx::Error> {
